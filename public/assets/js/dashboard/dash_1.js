...
var options1 = {
  ...
  series: [{
      name: $(".reservations-label").val(),
      data: JSON.parse($(".reservations-numbers").val())
  }],
  labels: JSON.parse($(".reservations-months").val()),
  xaxis: {
    axisBorder: {
      show: false
    },
  ...
  */
  ...
  var options = {
        ...
        series: [parseInt($('.male-count').val()), parseInt($(".female-count").val())],
        labels: [$('.male-label').val(), $('.female-label').val()],
        responsive: [{
            breakpoint: 1599,
            options: {
                chart: {
