...
jQuery($=> {
   ...
   $(body).append('<a style="background-image: linear-gradient(to right, #25D366 0%, #49ee87 51%, #25D366 100%);" onclick="openWhatsapp()"  class="back-top"><i style=" color: white;" class="fa fa-whatsapp"></i></a>');
     let amountScrolled = 700;
    let backBtn = $("a.back-top");
    $window.on("scroll", function () {
        if ($window.scrollTop() > amountScrolled) {
