					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<a href="<?php echo e($slide->link); ?>">
								<img src="/storage/images/<?php echo e($slide->image); ?>">
							</a>
		...
		<div class="content-inner-3 section-pattren1">
			<div class="container">
				<div class="section-head text-center wow fadeInUp" data-wow-delay="0.2s">
					<h2 class="title"><?php echo e(__('lang.programs')); ?></h2>
		...
		<section class="content-inner-3 voting-intro">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-4 col-md-12 m-b30 text-end d-lg-block wow fadeInUp" data-wow-delay="0.4s">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demosupercode/public_html/resources/views/front/index.blade.php ENDPATH**/ ?>