            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="text-muted f-w-400">
                        ...
                        <?php endif; ?>
                        <h3 style="color:#333">اعتذار عيادة <?php echo e($clinic->name); ?></h3>
                    </div>
                    <form method="post" action="/admin/clinics/apology">
                        <?php echo csrf_field(); ?>

                        <label class="form-label">تاريخ الاعتذار</label>
                        <select class="form-control" name="date" required>
                            <option selected disabled value=''>تحديد تاريخ الاعتذار</option>
                        ...
                        <textarea name="reason_apology" placholder="سبب الاعتذار" class="form-control"></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/reservations/create_apology.blade.php ENDPATH**/ ?>