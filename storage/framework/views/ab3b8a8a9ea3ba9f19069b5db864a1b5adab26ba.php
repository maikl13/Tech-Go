                    ...
                    <div class="add-product">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable" style="margin-top: 10px">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><img src="/uploads/images/<?php echo e($r->image); ?>" width="80px"></td>
                                    <td>
                                        <?php echo e($r->name_ar); ?> <br/> <?php echo e($r->name_en); ?>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="/admin/teams/<?php echo e($r->id); ?>/delete">حذف</a>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eda7hy73qgy6/public_html/tech-go.net/resources/views/teams/index.blade.php ENDPATH**/ ?>