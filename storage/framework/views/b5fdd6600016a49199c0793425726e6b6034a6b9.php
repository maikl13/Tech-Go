  ...
  <body>
    ...
    <div class="whatsappContact">
      ...
      <div class="buttonAnim whatsapp">
        ...
        <a href="<?php echo e(url('/')); ?>/whatsapp/contact?url=https://wa.me/<?php echo e($settings->where('key','contact_whatsapp')->first()->value); ?>?text=<?php echo e($settings->where('key','whatsapp_main_text_' . app()->getLocale())->first()->value); ?>">
