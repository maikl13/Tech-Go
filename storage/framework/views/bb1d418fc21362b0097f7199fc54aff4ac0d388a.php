                            ...
                            <div class="col-12">
                                ...
                                <div class="images">
                                    ...
                                    <div class="image-item">
                                        <img src="/storage/images/<?php echo e($img->image); ?>" style="width:150px;display:block" />
                                        <a href="<?php echo e(url('/')); ?>/admin/programs/images/<?php echo e($img->id); ?>/delete">حذف</a>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\charity\resources\views/dashboard/edit-program.blade.php ENDPATH**/ ?>