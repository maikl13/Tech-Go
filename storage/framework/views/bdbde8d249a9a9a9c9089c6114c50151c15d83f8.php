            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="text-muted f-w-400">
                        <h3 style="color:#333">إضافة خطوات عمل</h3>
                    </div>
                    <form method="POST" action="/admin/steps" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
