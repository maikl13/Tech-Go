    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                ...
                <h3 style="color:#333">مميزاتنا</h3>
                <section>
                    <div class="product-status-wrap border-pdt-ct">
                        <div class="add-product">
                            <a href="/admin/features/create" class="btn btn-outline-primary">إضافة</a>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td><img src="/storage/images/<?php echo e($s->image); ?>" width="100px"/></td>
                                        ...
                                        <a class="btn btn-danger"
                                               href="/admin/features/<?php echo e($s->id); ?>/delete">حذف</a>
                                            <a class="btn btn-outline-primary"
                                               href="/admin/features/<?php echo e($s->id); ?>/edit">تعديل</a>
                                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dradel\resources\views/dashboard/features.blade.php ENDPATH**/ ?>