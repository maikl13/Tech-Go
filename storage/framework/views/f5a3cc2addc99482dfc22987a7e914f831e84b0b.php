                ...
                <div class="tile-body">
                    ...
                    <form method="POST" action="/admin/gallery/update"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label>الصورة الكاملة</label>
                                <input type="file" name="full_image" class="form-control" 
                                       >
                                       <img src="/storage/images/<?php echo e($gallery->full_image); ?>" style="width:150px;display:block" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dradel\resources\views/dashboard/edit-gallery.blade.php ENDPATH**/ ?>