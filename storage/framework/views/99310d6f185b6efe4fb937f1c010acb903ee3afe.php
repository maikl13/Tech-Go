                ...
                <section>
                    <div class="product-status-wrap border-pdt-ct">
                        <div class="add-product">
                            <a href="/admin/programs/create?type=<?php echo e($type); ?>" class="btn btn-outline-primary">إضافة</a>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\charity\resources\views/dashboard/programs.blade.php ENDPATH**/ ?>