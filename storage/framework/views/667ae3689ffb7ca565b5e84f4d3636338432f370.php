            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <form method="POST" action="<?php echo e(action('SuperCategoriesController@store')); ?>"
                        ...
                        <input type="text" name="name" class="form-control" <?php if(env('ACCOUNTING_CONNECT', 'no') == 'yes'): ?> readonly <?php endif; ?> placeholder="إسم القسم بالإنجليزي" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/super_categories/create.blade.php ENDPATH**/ ?>