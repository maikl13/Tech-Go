    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                ...
                <h3 style="color:#333">طلبات الاستشارات</h3>
                <section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dradel\resources\views/dashboard/medical-requests.blade.php ENDPATH**/ ?>