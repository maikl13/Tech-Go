            ...
            <div class="tile">
                <div class="tile-body about-body">
                    <div class="text-muted f-w-400">
                        <h3 style="color:#333">اضافة برنامج                  
                        </h3>
                    </div>
                    <form method="POST" action="/admin/programs"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <label>البرنامج الرئيسي</label>
                                <select class="form-control" name="parent_id">
                                    <option value="0">بدون برنامج رئيسي</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea style="height:190px" name="content_ar" class="body form-control"></textarea>
                            </div>
                            <div class="col-12">
                                <label>محتوي البرنامج انجليزي</label>
                                <textarea style="height:190px" name="content_en" class="body form-control"></textarea>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demosupercode/public_html/resources/views/dashboard/create-program.blade.php ENDPATH**/ ?>