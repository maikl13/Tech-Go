                ...
                <div class="tile-body">
                    ...
                    <form method="POST" action="/admin/videos/update"
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-12">
                                <label>الفيديو</label>
                                <textarea style="height:200px !important;direction:ltr" name="source" class="form-control"><?php echo e($video->source); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eda7hy73qgy6/public_html/tech-go.net/resources/views/dashboard/edit-video.blade.php ENDPATH**/ ?>