            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="text-muted f-w-400">
                        <h3 style="color:#333">إضافة مقالة</h3>
                    </div>
                    <form method="POST" action="/admin/blog/store" enctype="multipart/form-data">
                        ...
                        <textarea class="body form-control" name="content_ar"></textarea>

                        <label>محتوي المقالة انجليزي</label>
                        <textarea class="body form-control" name="content_en"></textarea>
                        ...
                        <select class="form-control" name="category_id" >
                            ...
                            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>"><?php echo e($c->name_ar); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dradel\resources\views/blog/create.blade.php ENDPATH**/ ?>