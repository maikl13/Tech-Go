                        ...
                        <form action="<?php echo e(url('/')); ?>/login" method="post" class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input  value="<?php echo e(old('email')); ?>" id="email" name="email" type="email" class="form-control <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" placeholder="البريد الالكتروني">
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eda7hy73qgy6/public_html/tech-go.net/resources/views/auth/login.blade.php ENDPATH**/ ?>