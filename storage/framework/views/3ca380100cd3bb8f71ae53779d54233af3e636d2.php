            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="text-muted f-w-400">
                        <h3 style="color:#333">إضافة سجل طبي</h3>
                    </div>
                    <form method="POST" action="/admin/medical_records/store">
                        <?php echo csrf_field(); ?>
                        ...
                        <input type="text" name="patient_national_id" class="form-control"
                               >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/medical_records/create.blade.php ENDPATH**/ ?>