...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                <h3 style="color:#333;float:right">المنتجات الغير فعالة</h3>
                <br/>
                <br/>
                ...
                <section>
                    <div class="product-status-wrap border-pdt-ct">
                        ...
                        <div class="row" style="margin: 5px;">
                            ...
                            <div class="col-2" style="padding-left: 5px;padding-right: 5px;">
                                <a href="/admin/products_inactive/<?php echo e($search); ?>/<?php echo e($super_category_id); ?>"
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <form method="post" action="/admin/products/status_active">
                                        ...
                                        <td><img src="/storage/small_image/<?php echo e($p->image); ?>" width="50px"></td>
    ...
    <script>
        ...
        $('select').on('change', function () {
            ...
            if (search.value.length == 0) {
                document.getElementById('search_button').setAttribute('href', '/admin/products_inactive/' + 'all' + '/' + super_category_id.value);
            } else {
                document.getElementById('search_button').setAttribute('href', '/admin/products_inactive/' + search.value + '/' + super_category_id.value);
            }
        ...
        $('#search').keypress(function (e) {
            if (e.which == 13) {
                ...
                var search = document.getElementById('search');
                if (search.value.length == 0) {
                    window.location.href = '/admin/products_inactive/' + 'all' + '/' + super_category_id.value;
                } else {
                    window.location.href = '/admin/products_inactive/' + search.value + '/' + super_category_id.value;
                }
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/products/products_inactive.blade.php ENDPATH**/ ?>