            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="text-muted f-w-400">
                        <h3 style="color:#333">تعديل حجز <?php echo e($data->id); ?></h3>
                    </div>
                    <form method="post" action="/admin/reservation/update">
                        ...
                        <select class="form-control" name="status" required>
                            <?php
                                $slots = ["send","confirm_dr","apology_dr","apology_patient"];
                            ?>
                            <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option <?php if($item == $data->status): ?> selected <?php endif; ?>><?php echo e($item); ?></option>
                              
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>

                        <label class="form-label">سبب الاعتذار</label>
                        <textarea class="form-control" name="reason_apology"></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/reservations/edit.blade.php ENDPATH**/ ?>