					...
					<div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
						...
						<ul class="nav navbar-nav navbar navbar-left">	
							...
							<li class="sub-menu-down"><a href="javascript:void(0);"><?php echo e(__('lang.programs')); ?></a>
								<ul class="sub-menu">
									<li><a href="<?php echo e(url('/') . '/' . app()->getLocale()); ?>/programs/youth"><?php echo e(__('lang.youth_programs')); ?></a></li>
									<li><a href="<?php echo e(url('/') . '/' . app()->getLocale()); ?>/programs/education"><?php echo e(__('lang.education_programs')); ?></a></li>
								</ul>
							</li>
...
</html><?php /**PATH C:\laragon\www\charity\resources\views/front/layouts/app.blade.php ENDPATH**/ ?>