                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <select name="sub_category_id"  class="form-control" id="sub_category_id">
                            <option value="" selected disabled>إختيار القسم الفرعي</option>
                            <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>"
                                        <?php if($product->sub_category_id == $cat->id): ?> selected <?php endif; ?> ><?php echo e($cat->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                                ...
                                <div class="col-3" id="image_div_<?php echo e($i); ?>" style="padding: 5px">
                                    <div class="center-cropped"
                                         style="width: 100%;border: 2px solid #212f31;padding: 1px;border-radius: 3px 4px 0px 0px;height: 100px;
                                                 background-image: url('<?php echo e(url('/storage/images/', $i->image)); ?>');">
                                    ...
                                    <div style="background-color: #212e31;    border-radius: 0px 0px 3px 3px;width: 100%;text-align: center">
                                        <a href="<?php echo e(url('/storage/images/', $i->image)); ?>" target="_blank"
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xmarket/public_html/resources/views/products/edit.blade.php ENDPATH**/ ?>