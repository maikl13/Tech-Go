            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <?php if(session('success')): ?>
                            <p style="font-weight:bold;color:red"><?php echo e(session('success')); ?></p>
                        <?php endif; ?>
                        <h3 style="color:#333"> إضافة مرفق الي السجل الطبي #<?php echo e($r->id); ?></h3>
                    </div>
                    <form method="POST" enctype="multipart/form-data" action="/admin/medical_records/attachment/store">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/medical_records/create_attachment.blade.php ENDPATH**/ ?>