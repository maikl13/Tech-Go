                    ...
                    <div class="product-status-wrap border-pdt-ct">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable" style="margin-top: 10px">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td><?php echo e($s->page_url); ?></td>
                                    <td>
                                    <a class="btn btn-outline-primary"
                                            href="/admin/seo/<?php echo e($s->id); ?>/edit">تعديل</a>
                                    <a class="btn btn-danger"
                                            href="/admin/seo/<?php echo e($s->id); ?>/delete">حذف</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demosupercode/public_html/resources/views/seo/index.blade.php ENDPATH**/ ?>