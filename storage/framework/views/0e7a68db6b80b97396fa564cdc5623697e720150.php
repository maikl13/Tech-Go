            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <form method="post"
                        ...
                        <input type="text" name="name" class="form-control" placeholder="إسم القسم بالإنجليزية" <?php if(env('ACCOUNTING_CONNECT', 'no') == 'yes'): ?> readonly <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hajzakaltibi/public_html/resources/views/super_categories/edit.blade.php ENDPATH**/ ?>