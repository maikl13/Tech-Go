        ...
        <div class="container">
          ...
          <div class="all__Content flex-between">
            ...
            <div class="content__Info" data-aos="fade-left">
              ...
              <h1 class="titleInfo">{{$global_about['banner_title_' . app()->getLocale()]}}</h1>



              <input type="hidden" id="banner-strings" value='{{$global_about['banner_description_' . app()->getLocale()]}}' />
...
/971502440179?text=مرحبا انا مهتم بطلب إستشارة تقنية">طلب عرض سعر</a>
    ...
    width: 100%;
    height: 100%;
    padding: 15px;" href="{{url('/')}}/whatsapp/contact?url=https://wa.me/{{$settings->where('key','contact_whatsapp')->first()->value}}?text={{$settings->where('key','whatsapp_main_text_' . app()->getLocale())->first()->value}}"
                
                
                
                
                >{{__('lang.have_free_consulting')}}</a>
...
<button class="btn btnHead conversionButton">
    <a style="display: block; width: 100%; height: 100%; padding: 15px;" href="{{ url('/') }}/whatsapp/contact?url=https://wa.me/{{ $settings->where('key', 'contact_whatsapp')->first()->value }}?text={{ $settings->where('key', 'whatsapp_main_text_' . app()->getLocale())->first()->value }}">
        {{ __('lang.have_free_consulting') }}
    </a>
</button>
            </div>
            ...
            >
              ...
              @if(app()->getLocale() == "ar")
                src="{{url('/')}}/storage/images/{{$global_about['banner_image']}}"
              @else
              src="{{url('/')}}/storage/images/{{$global_about['banner_image_en']}}"
              @endif
          ...
          <div class="container">
            ...
            <div class="all__Bottom__Content flex-between">
              ...
              <div class="info" data-aos="fade-right">
                ...
                <h1 class="title">{{__('lang.our_goal')}}</h1>

                <p class="text">

                 {!!$global_about['our_goal_' . app()->getLocale()]!!}
              ...
              <div class="social__Bottom" data-aos="fade-up">
                ...
                <h1 class="title">{{__('lang.our_social_pages')}}</h1>
                ...
                <div class="list__Social">
                  ...
                  @if($instagram_link)
                    ...
                    <li class="linkSocial">
                      ...
                      <a style="position:relative;top:2px" href="{{$instagram_link}}">
