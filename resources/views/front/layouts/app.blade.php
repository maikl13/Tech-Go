...
<script>
  ...
  gtag('config', 'G-2JVPS90X9K');
    ...
    <link rel="stylesheet" href="{{url('/')}}/front/assets/css/library/aos.css" />

    <!-- File Owl -->

    <link rel="stylesheet" href="{{url('/')}}/front/assets/css/library/owl.carousel.min.css" />
    ...
    <link rel="stylesheet" href="{{url('/')}}/front/assets/css/dark.css" />
...
@endif
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="all__footer">
            ...
            <div class="footer_Logo" data-aos="fade-left">
              ...
              <img src="{{url('/')}}/storage/images/{{$global_about->about_logo}}" alt="image" />
            ...
            <div class="footerOne" data-aos="fade-right">
              ...
              <div class="titleFooter">{{__('lang.useful_links')}}</div>

              <ul class="linksFooter">

                <li class="link__Footer">

                  <a href="{{url('/' . app()->getLocale())}}" class="link__Item">{{__('lang.home')}}</a>

                </li>

                <li class="link__Footer">

                  <a href="{{url('/' . app()->getLocale())}}#About" class="link__Item">{{__('lang.about_us')}}</a>
                ...
                <li class="link__Footer">
                  ...
                  <a href="{{url('/' . app()->getLocale())}}/team" class="link__Item">{{__('lang.team')}}</a>
            ...
            <div class="footerOne" data-aos="fade-left">
              ...
              <div class="titleFooter">{{__('lang.contact_us')}}</div>

              <ul class="linksFooter">

                <li class="link__Footer">

                  <a href="tel:{{$settings->where('key','contact_phone')->first()->value}}" class="link__Item">
                ...
                <li class="link__Footer">
                  ...
                  <a href="mailto:{{$settings->where('key','contact_email')->first()->value}}" class="link__Item">
            ...
            <div class="footerOne" data-aos="fade-right">
              ...
              <div class="titleFooter">{{__('lang.newsletter_title')}}</div>

              <form style="width: 100%;display: inherit;" class="newsletter" action="{{url('/')}}/newsletter/submit">



              <div class="subscribe">

                <input type="email" name="email" required placeholder="{{__('lang.email')}}" />
          ...
          <div class="container">
            ...
            <div class="all__final__footer">
              ...
              <a href="#!" class="linkTitle">
                ...
                {{__('lang.all_rights_reserved')}} <span>TechGo@</span> 2023
    ...
    <script src="{{url('/')}}/front/assets/js/library/aos.js"></script>

    <!-- File counter -->

    <script src="{{url('/')}}/front/assets/js/library/purecounter_vanilla.js"></script>
    ...
    <script src="{{url('/')}}/front/assets/js/library/typed.min.js"></script>
    ...
    <script src="{{url('/')}}/front/assets/js/library/owl.carousel.min.js"></script>
