...
@section('header')
  ...
  @include('front.layouts.parts.header-home')
        ...
        <div class="container">
          ...
          <div class="all__main flex-between">
              ...
              <span class="number__Count">
                ...
                <div class="mainCounter">
                  ...
                  <span
                    ...
                    data-purecounter-end="{{$global_about['about_experience_years']}}"
                ...
                <span class="text">{{__('lang.experience_years')}}</span>
            ...
            <div class="content" data-aos="fade-right">
              ...
              <h1 class="title">{{$global_about['about_title_' . app()->getLocale()]}}</h1>

              <p class="text">

              {{$global_about['about_description_' . app()->getLocale()]}}
          ...
          <div class="videoBanner">
            ...
            <div class="img_Video" data-aos="fade-up">
              ...
              <div class="imgOver">
                ...
                <img src="{{url('/')}}/front/assets/images/bg/01.webp" alt="imgVideo" />
          ...
          <div class="tech">
            ...
            <div class="section__title" data-aos="fade-down">
              ...
              <h1 class="title">{{__('lang.in_tech_go')}}</h1>

              <p class="text">

               {{__('lang.in_tech_go_description_part_1')}}

               {{$global_about['about_clients_count']}}

               {{__('lang.in_tech_go_description_part_2')}}
            ...
            <div class="mockup__content">
              ...
              <div class="img__Mockup" data-aos="zoom-in">
                ...
                <img src="{{url('/')}}/front/assets/images/shape/sam.png" alt="image" />
              ...
              <div class="num__Counter counter01">
                ...
                <div class="imgBg">
                  ...
                  <img src="{{url('/')}}/front/assets/images/shape/03.svg" alt="imgBg" />
                ...
                <div class="content__num">
                  ...
                  <span
                    ...
                    data-purecounter-end="{{$global_about['about_websites_count']}}"
                  ...
                  <span class="text"> {{__('lang.website')}} </span>
              ...
              <div class="num__Counter counter02">
                ...
                <div class="imgBg">
                  ...
                  <img src="{{url('/')}}/front/assets/images/shape/04.svg" alt="imgBg" />
                ...
                <div class="content__num">
                  ...
                  <span
                    ...
                    data-purecounter-end="{{$global_about['about_apps_count']}}"
                  ...
                  <span class="text"> {{__('lang.app')}} </span>
          ...
          <div class="section__title" data-aos="zoom-in">
            ...
            <div class="main_title">
              ...
              <p class="text">
                ...
                {{__('lang.services_sub_title')}}

              </p>

            </div>

            <a href="{{url('/' . app()->getLocale())}}/services" class="linkTitle"

              >{{__('lang.show_all_services')}}
      ...
      <section class="cards__Projects">
        ...
        <div class="container">
          ...
          <div class="section__title" data-aos="fade-down">
            ...
            <h1 class="title">{{__('lang.we_are_here_to_help_you')}}</h1>

            <p class="text">{{__('lang.project_steps')}}</p>
           ...
           @foreach($steps as $key => $item)
            ...
            <div class="card__Project__One" data-aos="fade-left">
              ...
              <div class="icon">
                ...
                <img src="/uploads/images/{{$item->icon}}" />
              ...
              <div class="info">
                ...
                <p class="text">{{$item['description_' . app()->getLocale()]}}</p>
      ...
      <div class="customer">
        ...
        <div class="container">
          ...
          <div class="section__title" data-aos="fade-right">
            ...
            <h1 class="title">{{__('lang.clients_feedback')}}</h1>
          ...
          @foreach($videos as $item)
            ...
            <div class="customerOne">
              ...
              <div class="img__Customer">
                ...
                <!-- <img src="{{url('/')}}/front/assets/images/frame_white.png"  style="position:absolute;z-index:9" /> -->
      ...
      <section class="Apps">
        ...
        <div class="container">
          ...
          <div class="section__title" data-aos="fade-up">
            ...
            <p class="text text_UP">{{__('lang.we_can_also_develope')}}</p>

            <h1 class="title">{{__('lang.mobile_applications')}}</h1>

            <p class="text">

              {{__('lang.tell_us_your_app_idea')}}
              ...
              <div class="app__One appRight" data-aos="fade-right">
                ...
                <div class="contentApp">
                  ...
                  <div class="info__App">
                    ...
                    <h1 class="title">{{__('lang.powerful_code')}}</h1>
              ...
              <div class="app__One appRight" data-aos="fade-right">
                ...
                <div class="contentApp">
                  ...
                  <div class="info__App">
                    ...
                    <h1 class="title">{{__('lang.easy_publish')}}</h1>

                    <p class="text">

                     {{__('lang.publish_desc')}}
              ...
              <div class="app__One appLeft" data-aos="fade-left">
                ...
                <div class="contentApp">
                  ...
                  <div class="info__App">
                    ...
                    <h1 class="title">{{__('lang.ui_design')}}</h1>
              ...
              <div class="app__One appLeft" data-aos="fade-left">
                ...
                <div class="contentApp">
                  ...
                  <div class="info__App">
                    ...
                    <h1 class="title">{{__('lang.customization')}}</h1>

                    <p class="text">{{__('lang.customization_desc')}}</p>
        ...
        <div class="container">
          ...
          <div class="buttonMorePortfolio" data-aos="fade-up">
            ...
            <button class="btn btnMore">
              ...
              <a href="{{url('/' . app()->getLocale())}}/projects">{{__('lang.explore_more')}}</a>
        ...
        <div class="container">
          ...
          <div class="section__title">
            ...
            <div class="main_title" data-aos="fade-left">
              ...
              <h1 class="title">{{__('lang.explore_our_products')}}</h1>

              <p class="text">{{__('lang.our_products')}}</p>
          ...
          <div class="buttonMorePortfolio" data-aos="fade-up">
            ...
            <button class="btn btnMore">
              ...
              <a href="{{url('/' . app()->getLocale())}}/products">{{__('lang.explore_more')}}</a>
      ...
      <div class="testimonials">
        ...
        <div class="container">
          ...
          <div class="section__title" style="padding-top:0" data-aos="fade-right">
            ...
            <h1 class="title">{{__('lang.people_trusted_us')}}</h1>
          ...
          @foreach($partners as $item)
            ...
            <div class="testimonial__One">
              ...
              <div class="icon__Image">
                ...
                <img src="{{url('/')}}/uploads/images/{{$item->image}}" alt="imgTest" />
              ...
              <div class="info__testimonial">
                ...
                <h1 class="title">{{$item['name_' . app()->getLocale()]}}</h1>
              ...
              <div class="bottom__Info">
                ...
                <a href="{{$item->link}}" class="LinkTest"

                  >{{__('lang.visit_website')}}
                ...
                <h2 class="title">{{$item['location_' . app()->getLocale()]}}</h2>
...
@endforeach
          ...
          <div class="all__Contact">
            ...
            <div class="right__Contact" data-aos="fade-left">
              ...
              <div class="content">
                ...
                <h1 class="title">{{__('lang.contact_us')}}</h1>

                <p class="text">

                  {{__('lang.contact_desc')}}
              ...
              <div class="call__Us">
                ...
                <div class="cont__One">
                  ...
                  <a href="#!" class="linkIconText">
                    ...
                    {{$settings->where('key','address_' . app()->getLocale())->first()->value}}
                ...
                <div class="cont__One">
                  ...
                  <a href="mailto:{{$settings->where('key','contact_email')->first()->value}}" class="linkIconText" id="emailAdd">

                  {{$settings->where('key','contact_email')->first()->value}}
                ...
                <div class="cont__One">
                  ...
                  <a href="tel:{{$settings->where('key','contact_phone')->first()->value}}" class="linkIconText" id="numberContact">

                  {{$settings->where('key','contact_phone')->first()->value}}
                ...
                <div class="cont__One">
                  ...
                  {{$settings->where('key','record_number')->first()->value}}
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="grid">
                      ...
                      <input type="text" name="name" placeholder="{{__('lang.name')}}" required />

                      <input type="text" name="company_name" placeholder="{{__('lang.company')}}" required />
                  ...
                  <li>
                    ...
                    <div class="grid">
                      ...
                      <input type="text" name="company_location" placeholder="{{__('lang.company_location')}}" />
                  ...
                  <li>
                    ...
                    <div class="grid">
                      ...
                      <input
                        ...
                        placeholder="{{__('lang.phone_with_code')}}"
                  ...
                  <li>
                    ...
                    <input name="subject" type="text" placeholder="{{__('lang.subject')}}" required />
    ...
    font-size: 12pt;">{{__('lang.message_sent')}}</p>

                  </li>

                  <li>

                    <button class="btn" type="submit">{{__('lang.send')}}</button>
        ...
        <div class="container">
          ...
          @endforeach
            ...
            <div class="technologyOne">
              ...
              <a href="{{url('/' . app()->getLocale())}}/techs" class="linkMore"
