                    ...
                    <form method="POST" action="/admin/services/{{$service->id}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <label>ايقونة</label>
                                @if($service->icon)
                                <img src="/storage/images/{{$service->icon}}" style="width:100px;display:block" />
                                @endif
                            ...
                            <div class="col-6">
                                ...
                                <textarea style="height:190px !important" name="content_ar" class="form-control">{{$service->content_ar}}</textarea>
                            </div>
                            <div class="col-6">
                                <label>وصف انجليزي</label>
                                <textarea style="height:190px !important" name="content_en" class="form-control">{{$service->content_en}}</textarea>
                            </div>
