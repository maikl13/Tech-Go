                    ...
                    <form method="POST" action="/admin/about/update"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <textarea style="height:200px !important;direction:ltr" name="about_video" class="form-control">{{$about->about_video}}</textarea>
                            ...
                            <div class="col-6">
                                ...
                                <textarea style="height:200px !important;direction:ltr" name="about_video_en" class="form-control">{{$about->about_video_en}}</textarea>
