<aside class="app-sidebar" id="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
                                        ...
                                        alt="Administator">
        <div>
            <center><p class="app-sidebar__user-name">{{auth()->user()->name}}</p>
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="/admin/sliders"><i class="app-menu__icon fa fa-bars"></i><span
                        class="app-menu__label">التابلت</span></a></li>                         
        ...
        <li><a class="app-menu__item" href="/admin/users/{{auth()->user()->id}}/edit"><i class="app-menu__icon fa fa-user-circle"></i><span
